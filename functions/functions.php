...
if (!function_exists('mv_slider_options')) {
    function mv_slider_options()
    {
        ...
        wp_enqueue_script('mv-slider-options-js', MV_SLIDER_URL.'vendor/flexslider/flexslider.js', ['jquery'], MV_SLIDER_VERSION, true);
        wp_localize_script('mv-slider-options-js', 'SLIDER_OPTIONS', [
